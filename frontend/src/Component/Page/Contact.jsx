...
export default function Contact() {
  ...
  const buttonText = status === 'loading' ? 'Sending...' : status === 'success' ? 'Sent!' : status === 'error' ? 'Error!' : 'Send Message';

  const buttonClass =
    status === 'success'
      ? 'bg-green-500 hover:bg-green-600 text-white font-semibold py-3 rounded-lg transition'
      : status === 'error'
      ? 'bg-red-500 hover:bg-red-600 text-white font-semibold py-3 rounded-lg transition'
      : 'bg-yellow-500 hover:bg-yellow-600 text-white font-semibold py-3 rounded-lg transition';
